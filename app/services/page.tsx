...
export default function ServicesPage() {
  return (
    <>
      <Head>
        <title>Services | Cisco's Painting - Quality Craftsmanship in Oregon</title>
        <meta
          name="description"
          content="Explore the wide range of quality painting, roofing, siding, and restoration services offered by Cisco's Painting in Salem and Portland metro."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://ciscospainting.com/services" />

        <meta property="og:title" content="Services | Cisco's Painting" />
        <meta
        ...
        <meta name="twitter:title" content="Services | Cisco's Painting" />
        <meta
