...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>Home | Cisco's Painting - Quality Craftsmanship in Oregon</title>
        <meta
          name="description"
          content="Cisco's Painting offers expert residential and commercial painting, roofing, siding, carpentry, and restoration services in Salem, Oregon and Portland metro since 2013."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://ciscospainting.com" />

        <meta property="og:title" content="Home | Cisco's Painting" />
        <meta
        ...
        <meta name="twitter:title" content="Home | Cisco's Painting" />
        <meta
