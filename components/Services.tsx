  ...
  return (
    <Box
      ...
      sx={{
        ...
        px: { xs: 2, md: 10 },
        py: 8,
        overflow: 'hidden', // Prevent container from causing scroll when cards expand
      }}
    >
      ...
      <Box sx={{ 
        ...
        <Grid 
          ...
          maxWidth="1200px"
          sx={{
            overflow: 'visible', // Important to allow cards to overlap
          }}
        >
          {servicesData.map(({ id, title, description, image, gradient }) => (
            <Grid
              ...
              sx={{
                position: 'relative',
                zIndex: hoveredId === id ? 2 : 1, // Bring hovered card to front
